...
export default function page() {
  ...
  return (
    ...
    <Footer/>
    <ToastContainer />
  <RiChatAiFill onClick={()=> setChat(!chat)} className="txtCol fixed bottom-20 right-5 animate-bounce hover:animate-none"/>
  {chat &&
  <div className="shadow-glow-mild p-5 rounded-sm bg-white flex flex-col fixed bottom-40 right-5">
    <div className="font-bold">Contact our agents via ✉️</div>
<div>
  <Link href="mailto:Carltonjeffersontrading@gmail.com">Carltonjeffersontrading@gmail.com</Link> or
  <Link href="mailto:Bryanwindham4@gmail.com"> Bryanwindham4@gmail.com</Link>
</div>
<div className="font-bold">Join our trading community 📈</div>
<div>
  <Link href="https://t.me/coingrowthz" target="_blank" rel="noopener noreferrer">
    https://t.me/coingrowthz
  </Link>
</div>
